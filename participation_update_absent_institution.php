<?php
$page_title = 'Update Participation of the Volunteer to Absent';
				...
				// Check for a valid ID, through GET or POST:
					...
					<div class="container mx-auto" style="width: 50rem;"><br>
						...
						<div class="card-header">
							<img src="images/pu.png" class="p-3 mb-2" height="200" alt="Reject Application Logo" loading="lazy" style="margin-top: -1px />
						</div>
						<div class="card-body text-start">';
							...
							if ($_SERVER['REQUEST_METHOD'] == 'POST') {
								if ($_POST['sure'] == 'Yes') { // Confirm that the volunteer is absent
			
									// Make the query:
									$q = "UPDATE application SET application.status='ABSENT' WHERE application.id = $id LIMIT 1";
									...
									if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
										...
										echo '<a href="participation_update_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
									...
									echo '<center><script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
										...
										</br><p>The participation has <b>NOT</b> been update.</p></br>';
									echo '<a href="participation_update_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
								}
							...
							if (mysqli_num_rows($r) == 1) { // Valid ID, show the form.
								...
								Are you <b>SURE</b> that <b>$row[3]</b> is absent?";
		
								// Create the form:
								echo '<form action="participation_update_absent_institution.php" method="post"><br/>
