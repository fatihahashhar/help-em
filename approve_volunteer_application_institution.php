<?php
$page_title = 'Approve Volunteer Application';
				...
				// Check for a valid ID, through GET or POST:
					...
					<div class="container mx-auto" style="width: 50rem;"><br>
						...
						<div class="card-header">
							<img src="images/aplapr.png" class="p-3 mb-2" height="200" alt="Approve Application Logo" loading="lazy" style="margin-top: -1px />
						</div>
						<div class="card-body text-start">';
							...
							if ($_SERVER['REQUEST_METHOD'] == 'POST') {
								if ($_POST['sure'] == 'Yes') { // Approve the application.
									...
									// Make the query:
									$q = "UPDATE application SET application.status='APPROVED' WHERE application.id = $id LIMIT 1";
									...
									if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
										...
										echo '</br><p>The application has been <b>approved</b>.</p></br>';
										echo '<a href="view_applications_pending_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
									} else { // If the query did not run OK.
										echo '<center><script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
											<lottie-player src="https://assets6.lottiefiles.com/packages/lf20_j3UXNf.json"  background="transparent"  speed="1"  style="width: 150px; height: 150px;"  loop  autoplay></lottie-player></br>
											<p class="error">The application could not be approved due to a system error.</p>'; // Public message.
									...
									echo '<center><script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
										...
										</br><p>The application has <b>NOT</b> been approved.</p></br>';
									echo '<a href="view_applications_pending_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
								}
							...
							if (mysqli_num_rows($r) == 1) { // Valid ID, show the form.
								...
								Do you want to <b>APPROVE</b> the application from <b>$row[3]</b>";
		
								// Create the form:
								echo '<form action="approve_volunteer_application_institution.php" method="post"><br/>
