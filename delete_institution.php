<?php $page_title = 'Delete an Institution'; ?>

<?php
// This page is for deleting a institution record.
			...
			<div>
				...
				echo '	<div class="container mx-auto" style="width: 50rem;"><br>
						...
						<div class="card-header">
							<img src="images\di.png" class="p-3 mb-2" height="200" alt="Delete Institution Logo" loading="lazy" style="margin-top: -1px />
						</div>
						<div class="card-body text-start">';
				if ((isset($_GET['id'])) && (is_numeric($_GET['id']))) { // From view_list_institution.php
					$id = $_GET['id'];
				...
				if ($_SERVER['REQUEST_METHOD'] == 'POST') {
					if ($_POST['sure'] == 'Yes') { // Delete the record.
						...
						// Make the query:
						$q = "DELETE FROM institution WHERE institution.id = $id";
						...
						if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
							...
							echo '</br><p>The institution has been <b>deleted</b>.</p></br>';
							echo '<a href="view_list_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
						} else { // If the query did not run OK.
							echo '<center><script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
<lottie-player src="https://assets6.lottiefiles.com/packages/lf20_j3UXNf.json"  background="transparent"  speed="1"  style="width: 150px; height: 150px;"  loop  autoplay></lottie-player></br>
<p class="error">The institution could not be deleted due to a system error.</p>'; // Public message.
						...
						echo '<center><script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
							...
							</br><p>The institution has <b>NOT</b> been deleted.</p></br>';
						echo '<a href="view_list_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
					}
				} else { // Show the form.
					...
					$q = "SELECT institution.name FROM institution WHERE institution.id = $id";
...
Are you sure you want to <b>DELETE</b> this institution from the system? ";

						// Create the form:
						echo '<form action="delete_institution.php" method="post">
<br/>
...
<a href="view_list_institution.php" style="background-color: #89C4E1;" class="btn btn-secondary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">CANCEL</a></div>
