                ...
                <div class="py-4 col-xl-15" style="padding-left: 12px;">
                  <div class="card text-center bg-light text-dark bg-opacity-100 w-100">
                    <div class="card-header">
                        <img src="images/recent_work.png" class="p-3 mb-2" height="160" alt="Help\'em Logo" loading="lazy" style="margin-top: -1px />
                    </div>
...
if (mysqli_num_rows($result) > 0) {
  ...
  while ($row = mysqli_fetch_assoc($result)) {
    ...
    <div class="col-md-3 w-25 p-3">
      <div class="card border rounded-4 shadow mb-4" style="background-color: #EEEEEE;">
  ...
  echo '</div></div>'; // Close the card-deck and container-fluid div tags
