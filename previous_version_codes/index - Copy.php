  ...
  <div align="middle">
            ...
            <div class="col-md-3 w-25">
              <div class="card border rounded-4 shadow mb-4" style="background-color: #EEEEEE; width: 100%;">
                ...
                <div class="card-footer p-3 text-center">
                  <a style="background-color: #89C4E1; width: 50%;" class="btn btn-secondary" href="read_more_voluntary_work_details_volunteer.php?id=' . $row['id'] . '"><i class="far fa-eye"></i> Read More</a>
                </div>
              </div>
            </div>';
          }
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col">
          <div class="position-relative">
            <img src="images/volunteer-hands.jpg" class="img-fluid" alt="Background Image" />
            <div class="overlay"></div>
            <div class="overlay-content">
              <p>Start volunteering now and together let's make a difference in the lives of others, empowering communities and fostering a sense of unity and support.</p>
              <a href="volunteer_registration.php" class="btn btn-primary">BE A VOLUNTEER</a>
            </div>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col">
          <div class="position-relative">
            <img src="images/helping-hand.png" class="img-fluid" alt="Background Image" />
            <div class="overlay"></div>
            <div class="overlay-content">
              <p>Start volunteering now and together let's make a difference in the lives of others, empowering communities and fostering a sense of unity and support.</p>
              <a href="volunteer_registration.php" class="btn btn-primary">BE A VOLUNTEER</a>
      ...
      echo '<div class="container-fluid">
              <div class="row">
                <div class="py-4 col-xl-12">
                  <div class="card text-center bg-light text-dark bg-opacity-100 w-75">
