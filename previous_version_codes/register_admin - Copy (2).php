...
require 'PHPMailer-master/src/src/PHPMailer.php';
require 'PHPMailer-master/src/src/SMTP.php';
require 'PHPMailer-master/src/src/Exception.php';
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
	...
	if (empty($errors)) {
		...
		// Make the query:
		$q = "INSERT INTO admin (username, email, password) VALUES ('$un', '$em', SHA1('$pw'))";
