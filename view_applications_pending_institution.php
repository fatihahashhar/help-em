            ...
            <div class="container mx-auto" style="width: 75rem;">
              <div class="card text-center bg-light text-dark bg-opacity-100" style="width: 75rem;">
                  ...
                  <div class="card-body text-start">';
                    ...
                    (
                      SELECT id FROM voluntary_work_institution WHERE institution_id = $inst_id AND application.status != 'REJECTED' AND application.status != 'APPROVED' AND application.status != 'PARTICIPATE' 
                    ...
                    echo '
                    <form id="search_box" class="m-3 d-flex justify-content-center" method="GET" action="view_applications_pending_institution.php">
                    ...
                    if (isset($_GET["search_query"])) {
                      ...
                      $sql = "SELECT id, status, volunteer_id, voluntary_work_id, voluntary_work_name, volunteer_username, volunteer_contact_number, organizer_of_voluntary_work_id
                              ...
                              (
                                  ...
                                  WHERE voluntary_work_institution.institution_id = $inst_id AND application.status != 'REJECTED' AND application.status != 'APPROVED' AND application.status != 'PARTICIPATE' 
                                  AND application.status != 'COMPLETED' AND application.status != 'ABSENT' AND application.status != 'DONE'
                                  ...
                                  WHERE voluntary_work_name IS NOT NULL AND organizer_of_voluntary_work_id = $inst_id AND status != 'APPROVED' AND status !='REJECTED' AND status != 'PARTICIPATE' 
                            ...
                            <tr>
                              ...
                              <td align="center">
                                <div>';
                                  ...
                                  if ($status == 'PENDING') { // If the status is 'PENDING'
                                    echo '<a style="background-color: #54B435;" class="btn btn-secondary" role="button" href="approve_volunteer_application_institution.php?id=' . $row['id'] . '"><i class="fa-solid fa-square-check"></i></a>';
                                  } else { // If the status is 'APPROVED' or 'REJECTED'
                              ...
                              <td align="center">
                                <div>';
                                  // Check if status is 'APPROVED' or 'REJECTED' to disable the button
                                  if ($status == 'PENDING') { // If the status is 'PENDING'
                                    echo '<a style="background-color: #DF2E38;" class="btn btn-danger" role="button" href="reject_volunteer_application_institution.php?id=' . $row['id'] . '"><i class="fas fa-trash"></i></a>';
                                  } else { // If the status is 'APPROVED' or 'REJECTED'
                    ...
                    <div class="mb-2">';
                      ...
                      if ($current_page > 1) {
                        echo "<a href='view_applications_pending_institution.php?page=" . ($current_page - 1) . "'>Previous &nbsp</a> ";
                      }
                      if ($start_range > 1) {
                        echo "<a href='view_applications_pending_institution.php?page=1'>1 &nbsp</a> ";
                        if ($start_range > 2) {
                          echo "... ";
                        }
                      }
                      for ($i = $start_range; $i <= $end_range; $i++) {
                        if ($i == $current_page) {
                          ...
                          echo "<a href='view_applications_pending_institution.php?page=$i'>$i &nbsp</a> ";
                        }
                      }
                      if ($end_range < $total_pages) {
                        ...
                        echo "<a href='view_applications_pending_institution.php?page=$total_pages'>$total_pages &nbsp</a> ";
                      }
                      if ($current_page < $total_pages) {
                        echo "<a href='view_applications_pending_institution.php?page=" . ($current_page + 1) . "'>Next &nbsp</a> ";
                      };
