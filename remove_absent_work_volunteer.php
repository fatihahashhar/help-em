	...
	echo '	
		...
		<div class="card text-center bg-light text-dark bg-opacity-100" style="width: 55rem;" >
			<div class="card-header">
				<img src="images\rw.png" class="p-3 mb-2" height="200" alt="Remove Work Logo" loading="lazy" style="margin-top: -1px />
			</div>
			<div class="card-body text-start">';
				...
				$q = "SELECT id, organizer_name, voluntary_work_name, voluntary_work_id, voluntary_work_date
				FROM
				(
					SELECT application.id, organization.name AS organizer_name, voluntary_work_organization.name AS voluntary_work_name,
						voluntary_work_organization.id AS voluntary_work_id, voluntary_work_organization.date AS voluntary_work_date
					FROM application
					...
					SELECT application.id, institution.name AS organizer_name, voluntary_work_institution.name AS voluntary_work_name,
						voluntary_work_institution.id AS voluntary_work_id, voluntary_work_institution.date AS voluntary_work_date
					FROM application
					LEFT JOIN voluntary_work_institution ON application.voluntary_work_institution_id = voluntary_work_institution.id
					LEFT JOIN voluntary_work_organization ON application.voluntary_work_organization_id = voluntary_work_organization.id
					...
					GROUP BY id, organizer_name, voluntary_work_name, voluntary_work_id, voluntary_work_date";
				$r = @mysqli_query($dbc, $q);
					...
					Voluntary Work Name: <b>$row[2]</b><br>
					Date: <b>$row[4]</b>
					</div></br>
					<b>REMOVE</b> this from your record?";
