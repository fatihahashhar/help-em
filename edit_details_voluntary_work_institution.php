...
<main>
	<div class="container pt-4">
		...
		<div class="card-body text-start">';
					...
					// Make the query:
					$q = "UPDATE voluntary_work_institution SET name='$na', task='$ta', description='$de', date='$da', start_time='$ti', end_time='$en', 
		...
		<lottie-player src="https://assets6.lottiefiles.com/packages/lf20_j3UXNf.json"  background="transparent"  speed="1"  style="width: 200px; height: 200px;"  loop  autoplay></lottie-player>';
				...
				function showForm($id)
				{
					...
					$q = "SELECT * FROM voluntary_work_institution WHERE voluntary_work_institution.id = $id";
		...
		<div class="card-body text-start">
			<form class="row g-3 px-2" action="edit_details_voluntary_work_institution.php?id=' . $id . '" method="post">
			<fieldset>';
						echo '
			...
			<div class="input-group mb-2">
				...
				<div class="col-md-4">
					...
					<option value="">Select</option>';
						...
						<div align="right">
							<input class="btn btn-primary btn-lg ms-2" style="background-color: #518cbb;" type="submit" name="submit" value=" Submit " /> &nbsp&nbsp
							<a href="view_voluntary_work_list_institution.php" class="btn btn-secondary btn-lg" style="background-color: #8fbfe7;" tabindex="-1" role="button" aria-disabled="true">CANCEL</a>
						</div>
			</div>
	</div>
	</form>
