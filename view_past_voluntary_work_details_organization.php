        ...
        <section class="mb-4">
          <div>
            <?php
				...
				$query1 = "SELECT voluntary_work_organization.id, voluntary_work_organization.name, voluntary_work_organization.task, voluntary_work_organization.description, voluntary_work_organization.date, 
				...
				FROM voluntary_work_organization
