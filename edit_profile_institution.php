<?php
// This page is for editing a institution record.
$page_title = 'Edit Profile Institution';
...
<main>
		...
		<section class="mb-4">
			...
			<div>
				...
				<div class="card-body text-start">';
					...
					// Make the query:
					$q = "UPDATE institution SET name='$na', email='$em', address='$ad', postcode='$po', city='$ci', state='$st', 
							contact_number='$co', bank_name='$ba', account_number='$ac' WHERE id = $id LIMIT 1";
					...
					if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
						...
						echo '<a href="profile_institution.php" class="btn btn-danger btn-lg col-sm-2 me-1 mb-3" tabindex="-1" style="background-color: #518cbb;" role="button" aria-disabled="true">DONE</a></center>';
						...
						echo '<a href="profile_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
				...
				function edit_profile($id)
				{
					...
					$q = "SELECT institution.name, institution.email, institution.address, institution.postcode, institution.city, 
	institution.state, institution.contact_number, institution.bank_name, institution.account_number 
	FROM institution WHERE institution.id = $id";
	...
	<div class="card-body text-start">
			<form class="px-4 py-2" action="edit_profile_institution.php?id=' . $id . '" method="post">
			<fieldset>';
			...
			<input required type="text" class="form-control" name="account_number" size="20" maxlength="20" value="' . $row['account_number'] . '">
				...
				?>
						...
						<div align="right"><input class="btn btn-danger btn-lg col-sm-2 mt-3 me-1" tabindex="-1" style="background-color: #518cbb;" aria-disabled="true" type="submit" name="submit" value=" Submit " /> &nbsp&nbsp
							<a href="profile_institution.php" class="btn btn-danger btn-lg col-sm-2 mt-3" style="background-color: #89C4E1;" tabindex="-1" role="button" aria-disabled="true">CANCEL</a>
						</div>
			</div>
			</form>
	<?php
