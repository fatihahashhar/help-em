				...
				// Check for a valid ID, through GET or POST:
					...
					<div class="container mx-auto" style="width: 50rem;"><br>
						...
						<div class="card-header">
							<img src="images/wc.png" class="p-3 mb-2" height="200" alt="Work Completion Logo" loading="lazy" style="margin-top: -1px />
						</div>
						<div class="card-body text-start">';
							...
							if ($_SERVER['REQUEST_METHOD'] == 'POST') {
								if ($_POST['sure'] == 'Yes') { // Approve the application.
									...
									// Make the query:
									$q = "UPDATE application SET application.status='COMPLETED' WHERE application.id = $id LIMIT 1";
							...
							if (mysqli_num_rows($r) == 1) { // Valid ID, show the form.
								...
								echo "<h5><b>Application ID: $row[0]</b></h5>
								Are you <b>SURE</b> that <b>$row[3]</b> has completed his/her work?";
		
								// Create the form:
								echo '<form action="participation_update_completed_institution.php" method="post"><br/>
