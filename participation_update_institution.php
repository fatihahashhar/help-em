              ...
              <div class="card text-center bg-light text-dark bg-opacity-100" style="width: 75rem;">
                  ...
                  <div class="card-body text-start">';
                    ...
                    $sql = "SELECT COUNT(*) AS total FROM application WHERE voluntary_work_institution_id IN 
                              (
                                SELECT id FROM voluntary_work_institution WHERE institution_id = $inst_id AND application.status != 'REJECTED' AND application.status != 'PENDING' AND application.status != 'COMPLETED'
                    ...
                    echo '
                    <form id="search_box" class="m-3 d-flex justify-content-center" method="GET" action="participation_update_institution.php">
                    ...
                    if (isset($_GET["search_query"])) {
                      ...
                      (
                          ...
                          WHERE voluntary_work_institution.institution_id = $inst_id AND application.status != 'REJECTED' AND application.status != 'PENDING' AND application.status != 'COMPLETED' AND application.status != 'DONE'
                      ...
                      WHERE voluntary_work_name IS NOT NULL AND organizer_of_voluntary_work_id = $inst_id AND app_status != 'PENDING' AND app_status != 'REJECTED' AND app_status != 'COMPLETED' AND app_status != 'DONE'";
                                ...
                                <tr>
                                  ...
                                  <td align="center">
                                    ...
                                    if ($status != 'REJECTED') { // If the status is 'REJECTED'
                                      echo '<a style="background-color: #89C4E1;" class="btn btn-secondary" role="button" href="view_applicants_details_participation_update_institution.php?id=' . $row['volunteer_id'] . '">VIEW</a>';
                                  ...
                                  <td align="center">
                                    <div>';
                                      ...
                                      if ($status != 'PARTICIPATE') { // If the status is 'PARTICIPATE'
                                        echo '<a style="background-color: #54B435;" class="btn btn-secondary" role="button" href="participation_update_participate_institution.php?id=' . $row['id'] . '"><i class="fa-solid fa-square-check"></i></a>';
                                  ...
                                  <td align="center">
                                    <div>';
                                      ...
                                      if ($status != 'ABSENT') { // If the status is 'ABSENT'
                                        echo '<a style="background-color: #DF2E38;" class="btn btn-danger" role="button" href="participation_update_absent_institution.php?id=' . $row['id'] . '"><i class="fa-solid fa-square-xmark"></i></a>';
                                  ...
                                  <td align="center">
                                    <div>';
                                      ...
                                      if ($status == 'PARTICIPATE') { // If the status is 'ABSENT' or 'PARTICIPATE'
                                        echo '<a style="background-color: #367E18;" class="btn btn-danger" role="button" href="participation_update_completed_institution.php?id=' . $row['id'] . '"><i class="fa-solid fa-thumbs-up"></i></a>';
                  ...
                  echo' 
                    <div class="mb-2">';
                      ...
                      if ($current_page > 1) {
                        echo "<a href='participation_update_institution.php?page=" . ($current_page - 1) . "'>Previous &nbsp</a> ";
                      }
                      if ($start_range > 1) {
                        echo "<a href='participation_update_institution.php?page=1'>1 &nbsp</a> ";
                        if ($start_range > 2) {
                          echo "... ";
                        }
                      }
                      for ($i = $start_range; $i <= $end_range; $i++) {
                        if ($i == $current_page) {
                          ...
                          echo "<a href='participation_update_institution.php?page=$i'>$i &nbsp</a> ";
                        }
                      }
                      if ($end_range < $total_pages) {
                        ...
                        echo "<a href='participation_update_institution.php?page=$total_pages'>$total_pages &nbsp</a> ";
                      }
                      if ($current_page < $total_pages) {
                        echo "<a href='participation_update_institution.php?page=" . ($current_page + 1) . "'>Next &nbsp</a> ";
                      };
