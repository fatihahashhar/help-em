	...
	// This page is for deleting a organization record.
	...
	<div class="card-header">
		<img src="images\do.png" class="p-3 mb-2" height="200" alt="Delete Organization Logo" loading="lazy" style="margin-top: -1px />
	</div>
<div class="card-body text-start">';
					if ((isset($_GET['id'])) && (is_numeric($_GET['id']))) { // From view_list_organization.php
						$id = $_GET['id'];
...
<lottie-player src="https://assets6.lottiefiles.com/packages/lf20_j3UXNf.json"  background="transparent"  speed="1"  style="width: 150px; height: 150px;"  loop  autoplay></lottie-player></br>';
					...
					if ($_SERVER['REQUEST_METHOD'] == 'POST') {
						if ($_POST['sure'] == 'Yes') { // Delete the record.
							...
							// Make the query:
							$q = "DELETE FROM organization WHERE organization.id = $id";
							...
							if (mysqli_affected_rows($dbc) == 1) { // If it ran OK.
								...
								echo '</br><p>The organization has been <b>deleted</b>.</p></br>';
								echo '<a href="view_list_organization.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
							} else { // If the query did not run OK.
								echo '<center><script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
<lottie-player src="https://assets6.lottiefiles.com/packages/lf20_j3UXNf.json"  background="transparent"  speed="1"  style="width: 150px; height: 150px;"  loop  autoplay></lottie-player></br>
<p class="error">The organization could not be deleted due to a system error.</p>'; // Public message.
							...
							</br><p>The organization has <b>NOT</b> been deleted.</p></br>';
							echo '<a href="view_list_organization.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>';
						}
					} else { // Show the form.
						...
						$q = "SELECT organization.name FROM organization WHERE organization.id = $id";
...
Are you sure you want to <b>DELETE</b> this organization from the system? ";

							// Create the form:
							echo '<form action="delete_organization.php" method="post">
<br/>
...
<a href="view_list_organization.php" style="background-color: #89C4E1;" class="btn btn-secondary btn-lg mb-3" tabindex="-1" role="button" aria-disabled="true">CANCEL</a></div>
