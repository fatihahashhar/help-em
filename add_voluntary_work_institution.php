...
<main>
	<div class="container pt-4">
		...
		<section class="mb-4">
			<div>
				<?php
				// This script performs an INSERT query to add a record to the voluntary_work_institution table.
				...
				if ($_SERVER['REQUEST_METHOD'] == 'POST') {
					...
					// Make the query:
					$q = (isset($_SESSION['institution_id']));
					$r = $_SESSION['institution_id']; // Run the query.

					$t = "INSERT INTO voluntary_work_institution (name, task, description, date, start_time, end_time, certification, institution_id, meals, transportation, allowance, status, image) VALUES ('$na', '$ta', '$de', '$da', '$ti', '$en', '$ce', '$r', '$me', '$tr', '$al', '$st', '$image')";
					...
					if ($u) { // If it ran OK
						...
						echo '<a href="view_voluntary_work_list_institution.php" style="background-color: #518cbb;" class="btn btn-primary btn-lg mb-3 mt-3" tabindex="-1" role="button" aria-disabled="true">DONE</a></center>
						</div></div></div>';
					...
					<div class="container mx-auto" style="width: 55rem;">
						<div class="card text-center bg-light text-dark bg-opacity-100" style="width: 55rem;" >
							...
							<div class="card-body text-start">
								<form class="row g-3 px-4 py-2 needs-validation" action="add_voluntary_work_institution.php" method="post" enctype="multipart/form-data">
									<fieldset>';
									echo '
